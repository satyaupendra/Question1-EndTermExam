...
class Courses extends Question1{
...
class ECE extends Courses{ //extend the parent class here 
	public String displayCourseDetails(String dept) {
		...
		String commonSubjects = obj.displayCourseDetails(dept);
...
class CSE extends Question1 { //extend the parent class here 
	public String displayCourseDetails(String dept) {
...
public class Question1 {
	public static void main(String[] args){
		...
		case 1:
		{
			ECE e = new ECE();//this case is or ECE
			System.out.println(e.displayCourseDetails("ECE"));//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			System.out.println("");//call the function of the class that you initialized
			break;
		}
		case 2:
		{
			Mechanical m = new Mechanical();//this case is or Mechanical
			System.out.println(m.displayCourseDetails("Mechanical"));//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			System.out.println("");//call the function of the class that you initialized
			break;
		}
		case 3:
		{
			CSE c = new CSE();//this case is or CSE
			System.out.println(c.displayCourseDetails("CSE"));//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			System.out.println("");//call the function of the class that you initialized
			break;
		}
		default:
